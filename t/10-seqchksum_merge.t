...
is(system("$startDir/bin/seqchksum_merge.pl $seqchksum_data/format1.sam $seqchksum_data/format2.bam $seqchksum_data/format3.cram $seqchksum_data/format4.seqchksum | LC_ALL=C sort > $tmpdir/merged.formats.matching.seqchksum"), 0, 'seqchksum_merge.pl create different formats test output exit status');
